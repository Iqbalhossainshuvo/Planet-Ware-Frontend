            ...
            <Container>
                    ...
                    <Col md={7}>
                        <div className="d-flex flex-column justify-content-start align-items-cetner shadow-sm p-2">
                            ...
                            <p className="d-flex align-items-center justify-content-start">
                                <span>
                                    <StarIcon style={{ color: '#6feb57', fontSize: '1rem' }} className="se_icon" />
                                    <StarIcon style={{ color: '#6feb57', fontSize: '.1rem' }} className="se_icon" />
                                    <StarIcon style={{ color: '#6feb57', fontSize: '1rem' }} className="se_icon" />
                                    <StarIcon style={{ color: '#6feb57', fontSize: '1rem' }} className="se_icon" />
                                    <StarIcon style={{ color: '#6feb57', fontSize: '1rem' }} className="se_icon" />
                ...
                <div className="mt-5 pt-5">
                    <div className="d-flex text-start py-3">
                        <h3><span style={{ borderBottom: '2px solid #99F188' }}>Related</span> <span style={{ color: '#97f185', borderBottom: '2px solid #97f185' }}>Places and events</span></h3>
                    </div>
                    <Row>
                        <Col md={4}>
                                ...
                                <Card className='se_Img_con bg-white border-0'>
                                    ...
                                    <Card.Body className="se_overlay">
                                        ...
                                        <Card.Text style={{ color: '##99F188 !important', fontSize: '.88em' }}>
                                            <LocationOnIcon style={{ color: '##99F188 !important', fontSize: '1em' }} /> Kaptai upazila
                                            <span style={{ color: '#6feb57' }} className="ms-4 fw-bold">$250</span>
                                        </Card.Text>
                                        <span className='se_love_con'>
                                            <span> <StarIcon style={{ color: '#6feb57' }} className="se_icon" /> 4.5</span>
                                        </span>
                                    </Card.Body>
                                </Card>
                            </Link>
