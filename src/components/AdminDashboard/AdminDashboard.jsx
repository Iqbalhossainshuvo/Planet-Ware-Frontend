      ...
      <Container>
        <div className="d-flex text-start py-3">
          <h3 className="text-capitalize">
            <span style={{ borderBottom: "2px solid #99F188" }}>
              {userData?.username}
            </span>{" "}
            <span
              style={{ color: "#97f185", borderBottom: "2px solid #97f185" }}
            >
              your dahsboard
            </span>
          </h3>
            ...
            <Row>
              <Col sm={3}>
                <Nav variant="pills" className="flex-column">
                  <Nav.Item>
                    <Nav.Link eventKey="first" className="tabone">
                      Home
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                  ...
                  <Nav.Item>
                    <Nav.Link eventKey="four" className="">
                      Booked events
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="five" className="">
                      Notifications
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                    <Nav.Link eventKey="six" className="">
                      Events Manament
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item>
                ...
                <Tab.Content>
                  ...
                  <Tab.Pane eventKey="second">
                    ...
                    <Form className="border-top py-2 shadow-sm p-3 rounded">
                      <Row className="mb-3 gy-3">
                        ...
                        <Col md={12}>
                          <Button
                            variant="outline-secondary w-100 text-capitalize"
                            size="sm"
                  ...
                  <Tab.Pane eventKey="third">
                    ...
                    <Table
                      ...
                      responsive
                      hover
                      className="rounded shadow-sm mt-4"
                    >
                      <thead>
                        <tr>
                        ...
                        {allUsers?.map((item, i) => (
                          <tr key={i}>
                            ...
                            <td className="d-flex justify-content-evenly">
                              ...
                              <Button
                                className="btn_edit"
                                onClick={() => handleShowUser(item?._id)}
                              >
                                Edit
                              </Button>
                            </td>
                  ...
                  <Tab.Pane eventKey="six">
                    <AdminNav />
                    <Form className="border-top py-2 shadow-sm p-3 rounded">
                      <h5 className="text-muted w-100 border-bottom">
                        Add new events:
                      </h5>
                    ...
                    <h5 className="text-muted w-100 border-bottom mt-3">
                      All events:
                    </h5>
              ...
              <Modal.Body>
                <Form className="border-top py-2 shadow-sm p-3 rounded">
                  <Row className="mb-3 gy-2">
                    ...
                    <Col md={6}>
                      <Form.Group
                        className="mb-3 d-flex justify-content-between align-items-center w-100"
                        controlId="formGridImg"
                      >
                        <Form.Label className="text-muted">Image</Form.Label>
                        {singleEvent &&
                        singleEvent.photos &&
                        singleEvent.photos.length > 0 ? (
                          <>
                            <Image
                              src={singleEvent.photos[0]}
                              loading="lazy"
                              style={{
                                width: "6rem",
                                height: "6rem",
                            ...
                            />
                            {singleEvent.photos[1] && (
                              <Image
                                src={singleEvent.photos[1]}
                                loading="lazy"
                                style={{
                                  width: "6rem",
                                  height: "6rem",
                            ...
                            {singleEvent.photos[2] && (
                              <Image
                                src={singleEvent.photos[2]}
                                loading="lazy"
                                style={{
                                  width: "6rem",
                                  height: "6rem",
                            ...
                            {singleEvent.photos[3] && (
                              <Image
                                src={singleEvent.photos[3]}
                                loading="lazy"
                                style={{
                                  width: "6rem",
                                  height: "6rem",
