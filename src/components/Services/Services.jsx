                                                    ...
                                                    <Link href={`/single-events/${item._id}`} className="text-decoration-none">
                                                        <Card className='s_Img_con bg-white border-0'>
                                                            ...
                                                            <Card.Body className="s_overlay">
                                                                ...
                                                                <Card.Text style={{ color: '##BCF5B1 ', fontSize: '.80em' }}>
                                                                    <LocationOnIcon style={{ color: '##BCF5B1 ', fontSize: '1em' }} />{item?.location}
                                                                    <span style={{ color: '#BCF5B1' }} className="ms-4 fw-bold">$ {item?.price}</span>
                                                                </Card.Text>
                                                                <span className='s_love_con'>
                                                                    <span> <StarIcon style={{ color: '#BCF5B1' }} className="s_icon" /> 4.5</span>
                                                                </span>
                                                            </Card.Body>
                                                        </Card>
                                                    </Link>
