    ...
    return (
        <div className="py-4" data-aos="fade-up">
            ...
            <div className="d-flex text-start py-5">
                <h3><span style={{ borderBottom: '2px solid #99F188' }}>About</span> <span style={{ color: '#97f185', borderBottom: '2px solid #97f185' }}>Planet Ware</span></h3>
            </div>
                <Card className='border-0 shadow-sm rounded' style={{backgroundColor: '#DFFBF1'}}>
                    ...
                    <Card.Body>
                        <blockquote className="blockquote mb-0">
                            <p style={{ color: '#6c757d ', fontSize: '.78em' }}>
                                {' '}
